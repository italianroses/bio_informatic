...
# cbmc // scRNAseq and 13-antibody sequencing of CBMCs   human CBMC (cord blood)
# hcabm40k // 40,000 Cells From the Human Cell Atlas ICA Bone Marrow Dataset
# ifnb // IFNB-Stimulated and Control PBMCs
# panc8 // Eight Pancreas Datasets Across Five Technologies
# pbmc3k // 3k PBMCs from 10X Genomics
# pbmcsca // Broad Institute PBMC Systematic Comparative Analysis 
